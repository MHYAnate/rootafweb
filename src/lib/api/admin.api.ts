...
export const adminApi = {
  ...
  updateAboutContent: (key: string, data: any) => adminApiClient.put(`/about/content/${key}`, data).then((r) => r.data),
    // Add these inside the existing adminApi object:

  // Objectives
  createObjective: (data: any) => adminApiClient.post('/about/objectives', data).then((r) => r.data),
  updateObjective: (id: string, data: any) => adminApiClient.put(`/about/objectives/${id}`, data).then((r) => r.data),
  deleteObjective: (id: string) => adminApiClient.delete(`/about/objectives/${id}`).then((r) => r.data),

  // Contact
  updateContact: (id: string, data: any) => adminApiClient.put(`/about/contact/${id}`, data).then((r) => r.data),

  // Social
  updateSocial: (id: string, data: any) => adminApiClient.put(`/about/social/${id}`, data).then((r) => r.data),
