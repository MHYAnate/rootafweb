...
export default function NewProductPage() {
  ...
  const onSubmit = (data: ProductFormData) => {
    // Pass images separately — the hook handles the two-step flow
    // (create product first, then attach images via /products/:id/images)
    const imagesToAttach = images.map((img, idx) => ({
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setValue('availability', v as any)
                  }
                >
