...
// ═══════════════════════════════════════════════════════════
// ANIMATED STAT CARD (Now Clickable)
// ═══════════════════════════════════════════════════════════
    ...
    <Link href={stat.href}>
      <div
        ...
        className={cn(
          ...
          'p-6 sm:p-7 h-full',
          'transition-all duration-500 ease-out',
          'hover:shadow-2xl hover:shadow-black/[0.08] dark:hover:shadow-black/30',
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <div className="mt-4 flex items-center gap-1.5 text-xs font-bold text-primary opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
    ...
    <section className="py-20 sm:py-28 relative overflow-hidden">
      ...
      <div className="container-custom">
        ...
        <div className="flex items-center justify-center gap-2 mb-10">
          <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-amber-50 dark:bg-amber-950/30 border border-amber-200/60 dark:border-amber-800/40">
            <MousePointerClick className="h-4 w-4 text-amber-600 dark:text-amber-400 animate-bounce" />
        ...
        {/* Primary Grid — 5 cards: 3 top + 2 bottom centered, or responsive */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 mb-10">
          {primaryStats.map((stat, idx) => (
            <AnimatedStatCard key={stat.label} stat={stat} index={idx} />
          ))}
